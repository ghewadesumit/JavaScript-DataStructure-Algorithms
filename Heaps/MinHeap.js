class MinHeap {
	...
	delete() {
		...
		if (this.heap.length > 2) {
			...
			// Now Heapify the tree, make sure it satisfy the constraints of Complete tree and minHeap
			// loop through until there's LeftChild, RightChild or
			// current element (After swapping) is greater than left and right child
			while (
				this.heap[leftIndex] &&
